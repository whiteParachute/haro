...
- 2026-04-22: whiteParachute — done
  - 实现完成（core Router + CLI ingress + checkpoint + 测试），文档同步完成，status 切为 done。
  - Team Orchestrator 尚未实现，team 模式暂回退到 single-agent，等 FEAT-014 接入。
