...
- D4（原 Q4，历史检索；2026-05-07 与 historical FEAT-035 D8 对齐后细化）：把 Web Channel 历史明确**分两类**——
  ...
  - 相同决议在 historical FEAT-035 D8 也有交叉记录。**不**在 Web Channel 内重起 FTS5 / 向量索引。

## 9. Changelog / 变更记录

- 2026-05-01: whiteParachute — 初稿（Phase 1.5 自用底座补完批次 1）
- 2026-05-06: whiteParachute — 收敛 Open Questions Q1–Q4 为 D1–D4（owner 决策：S3 不做 / 不分屏 / 不加密 / 历史搜索走 Haro MemoryFabric 兼容层）；当时新增 FEAT-035 承担 MemoryFabric v2 改造；sidecar 修订后该路径为历史兼容
