...
async function createSidecarDoctorStage(
  ...
  const paths = [
    ...
    { name: 'approval-decisions', path: sidecar.approvalDecisions.path, required: false },
    ...
    { name: 'patch-branches', path: sidecar.patchBranches.path, required: false },
  ...
  const corruptCounts = {
    ...
    approvalDecisions: sidecar.approvalDecisions.corruptCount,
    ...
    patchBranches: sidecar.patchBranches.corruptCount,
